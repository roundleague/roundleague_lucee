...
/* ============================================================
 * Game Clock — StatsApp side
 *
 * Runs a local countdown. On Start / Pause / Reset the current
 * clock state is POSTed to the API so the scoreboard can sync.
 * ============================================================ */
(function () {
  ...
  if (!displayEl) return; // playoffs — panel not rendered
  ...
  // Sync period from the existing bench-bar half toggle
  document.addEventListener('click', function (e) {
